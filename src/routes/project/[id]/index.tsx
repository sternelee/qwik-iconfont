      ...
      <div class="container mx-auto px-4 py-4">
        ...
        <div class="flex flex-wrap gap-2 mb-3">
          <div class="flex-1 min-w-[200px]">
            <div class="relative">
              <input type="text" class="input input-bordered input-sm w-full pl-9 pr-8" placeholder="搜索图标..." value={searchQuery.value} onInput$={(ev: any) => searchQuery.value = ev.target.value} />
